...
function apt-p(){
sudo aptitude purge  $(apt list --installed  | peco | cut -f1 -d"\/" )
}
alias npi='/home/lukas/n/bin/npminstall -g '
alias npu='/home/lukas/n/bin/npmuninstall -g '
...
alias xx="chmod +x"
alias _="sudo env "PATH=$PATH:/usr/games" "
...
alias cargo-env='source $HOME/.cargo/env'
#alias ls='exa'
alias cat='bat'
#alias l='lsd -a'
alias lt='lsd --tree'
...
alias apk='sudo apk'
alias untar="tar -xvf"
alias _chown='sudo chown -R $USER:$GROUP '
alias _chown-www='sudo chown -R www-data /var/www/ '
...
alias apt-installed='apt list --installed | grep $1'
alias apt-available='apt list --all-versions | grep $1 '
alias checkinstall-noinstall='sudo checkinstall --install=no '
# | cut -f1 -d"/" '
# FUNCTIONS
...
alias nmaps='sudo nmap -p 10-20000 '
alias dotdrop='/home/lukas/dotfiles/dotdrop.sh --cfg=/home/lukas/dotfiles/config.yaml'
